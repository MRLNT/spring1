...
public class AuthorServiceImpl implements AuthorService {
    ...
    public ResponseEntity<?> addAuthorService(AuthorRequest request) {
        // cek request, ada yang null atau tidak
        // kalo dia null dari field req nya nanti akan di throw exception
    ...
    public ResponseEntity<?> getAuthorsService() {
        // get all data authos dari repositores
    ...
    public ResponseEntity<?> getAuthorByIdService(String id) {
        // cari idnya ada atau engga
        // bikin kondisi negatif pada if nya
    ...
    public ResponseEntity<?> updateAuthorByIdService(String id, AuthorRequest request) {
        ...
        // ubah data authornya pakai sette
        if (request.getName() != "") {
        ...
        authorRepository.save(author);
        // retuinr respondata
        return ResponseHandler.responseData(200, "author successfullt updated", author);
    }
